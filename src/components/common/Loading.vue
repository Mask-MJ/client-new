...
<template>
  <div
    class="bg-overlay-content dark:bg-overlay pointer-events-none absolute left-0 top-0 z-100 size-full flex flex-col items-center justify-center transition-all duration-500"
